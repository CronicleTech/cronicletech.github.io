...
<head>
	...
	<title>Social Media: Which Platform is Which? | Cronicle</title>
	...
	<div class = "container quiz">
		...
		<div class = "row" style = "max-width: 100%;">
			...
			<div class = "col-sm-10 cover page">
				...
				<h1>Social Media: Which Platform is Which?</h1>
			...
			<div class = "col-sm-10 question page">
				...
				<h3>Which social media platform is primarily focused on professional networking and job searching?</h3>
			...
			<div class = "col-sm-10 question page">
				...
				<h3>On which platform can users "upvote" and "downvote" content?</h3>

				<div class = "row">

					<div class = "col-lg-6">

						<div class = "qbutton first" onclick = "check(false, 4, 7)">
					...
					<div class = "col-lg-6">
						...
						<div class = "qbutton second" onclick = "check(false, 5, 7)">
					...
					<div class = "col-lg-6">
						...
						<div class = "qbutton third" onclick = "check(false, 6, 7)">
					...
					<div class = "col-lg-6">
						...
						<div class = "qbutton fourth" onclick = "check(true, 7, 7)">
			...
			<div class = "col-sm-10 question page">
				...
				<h3>Which social media platform allows users to send "snaps" that disappear after a short time?</h3>
			...
			<div class = "col-sm-10 question page">
				...
				<h3>On which platform can you pin images and create visual boards?</h3>

				<div class = "row">

					<div class = "col-lg-6">

						<div class = "qbutton first" onclick = "check(true, 12, 12)">
					...
					<div class = "col-lg-6">
						...
						<div class = "qbutton second" onclick = "check(false, 13, 12)">
					...
					<div class = "col-lg-6">
						...
						<div class = "qbutton third" onclick = "check(false, 14, 12)">
					...
					<div class = "col-lg-6">
						...
						<div class = "qbutton fourth" onclick = "check(false, 15, 12)">
			...
			<div class = "col-sm-10 question page">
				...
				<h3>What is the main purpose of Reddit?</h3>
			...
			<div class = "col-sm-10 question page">
				...
				<h3>Which platform is known for its live streaming, gaming content, and interactive chat?</h3>

				<div class = "row">

					<div class = "col-lg-6">

						<div class = "qbutton first" onclick = "check(false, 20, 23)">
					...
					<div class = "col-lg-6">
						...
						<div class = "qbutton second" onclick = "check(false, 21, 23)">
					...
					<div class = "col-lg-6">
						...
						<div class = "qbutton third" onclick = "check(false, 22, 23)">
					...
					<div class = "col-lg-6">
						...
						<div class = "qbutton fourth" onclick = "check(true, 23, 23)">
			...
			<div class = "col-sm-10 question page">
				...
				<h3>Which social media platform was known for its short videos that last up to six seconds?</h3>
			...
			<div class = "col-sm-10 question page">
				...
				<h3>Which online marketplace is known for buying and selling handmade items?</h3>
			...
			<div class = "col-sm-10 question page">
				...
				<h3>Which of the following is the parent company of TikTok?</h3>
						...
						<div class = "bottom">
							...
							<div class = "panel" onclick = "answer(0)">
								...
								<p>
									...
									1. Which social media platform is primarily focused on professional networking and job searching?

									<br><br>

									a) Facebook <br>
									b) Instagram <br>
									<span class = "highlight">c) LinkedIn</span> <br>
									d) Snapchat <br>
								</p>
							...
							<div class = "panel" onclick = "answer(1)">
								...
								<p>
									...
									2. On which platform can users "upvote" and "downvote" content, influencing its visibility?
									...
									b) Vidio <br>
									c) TikTok <br>
									<span class = "highlight">d) Reddit</span> <br>
							...
							<div class = "panel" onclick = "answer(2)">
								...
								<p>
									...
									3. Which social media platform allows users to send "snaps" that disappear after a short time?

									<br><br>

									a) WhatsApp <br>
									<span class = "highlight">b) Snapchat</span> <br>
									c) Medium <br>
									d) Pinterest <br>
							...
							<div class = "panel" onclick = "answer(3)">
								...
								<p>
									...
									4. On which platform can you pin images and create visual boards?

									<br><br>

									<span class = "highlight">a) Pinterest</span> <br>
									b) Tumblr <br>
									c) Reddit <br>
									d) WhatsApp <br>
							...
							<div class = "panel" onclick = "answer(4)">
								...
								<p>
									...
									5. What is the main purpose of the social media platform Reddit?

									<br><br>

									a) Sharing photos and videos <br>
									b) Professional networking <br>
									<span class = "highlight">c) News aggregation</span> <br>
									d) Short-form video sharing <br>
							...
							<div class = "panel" onclick = "answer(5)">
								...
								<p>
									...
									6. Which platform is known for its live streaming, gaming content, and interactive chat?
									...
									b) Facebook <br>
									c) Instagram <br>
									<span class = "highlight">d) Twitch</span> <br>
							...
							<div class = "panel" onclick = "answer(6)">
								...
								<p>
									...
									7. Which social media platform was known for its short videos that last up to six seconds?

									<br><br>

									a) Netflix <br>
									<span class = "highlight">b) Vine</span> <br>
									c) Discord <br>
									d) Instagram <br>
							...
							<div class = "panel" onclick = "answer(7)">
								...
								<p>
									...
									8. Which online marketplace is known for buying and selling handmade items?

									<br><br>

									a) Amazon <br>
									b) Tokopedia <br>
									<span class = "highlight">c) Etsy</span> <br>
									d) Alibaba <br>
							...
							<div class = "panel" onclick = "answer(8)">
								...
								<p>
									...
									9. Which of the following is the parent company of TikTok?
									...
									b) Meta <br>
									c) Tencent <br>
									<span class = "highlight">d) ByteDance</span> <br>
