...
<head>
	...
	<title>Foundations of Pre-Algebra | Cronicle</title>
	...
	<div class = "container quiz">
		...
		<div class = "row" style = "max-width: 100%;">
			...
			<div class = "col-sm-10 cover page">
				...
				<h1>Foundations of Pre-Algebra</h1>

				<p>8 questions • 3 - 5 minutes</p>

				<img src = "image.webp" alt = "prealgebra" class = "full">
			...
			<div class = "col-sm-10 question page">
				...
				<h3>What is the value of 2x + 3 when x = 5?</h3>

				<div class = "row">

					<div class = "col-lg-6">

						<div class = "qbutton first" onclick = "check(false, 0, 3)">
					...
					<div class = "col-lg-6">
						...
						<div class = "qbutton second" onclick = "check(false, 1, 3)">
					...
					<div class = "col-lg-6">
						...
						<div class = "qbutton third" onclick = "check(false, 2, 3)">
					...
					<div class = "col-lg-6">
						...
						<div class = "qbutton fourth" onclick = "check(true, 3, 3)">
			...
			<div class = "col-sm-10 question page">
				...
				<h3>What is the perimeter of a rectangle with a length of 6 units and a width of 4 units?</h3>
			...
			<div class = "col-sm-10 question page">
				...
				<h3>If you subtract 3 from twice a number and get 11, what is the number?</h3>
			...
			<div class = "col-sm-10 question page">
				...
				<h3>What is the least common multiple (LCM) of 4 and 6?</h3>
			...
			<div class = "col-sm-10 question page">
				...
				<h3>If 2x + 5 = 11, what is the value of x?</h3>
			...
			<div class = "col-sm-10 question page">
				...
				<h3>Which of the following fractions is equivalent to 3/4?</h3>
			...
			<div class = "col-sm-10 question page">
				...
				<h3>If a triangle has sides of lengths 5, 12, and 13, what type of triangle is it?</h3>

				<div class = "row">

					<div class = "col-lg-6">

						<div class = "qbutton first" onclick = "check(false, 28, 31)">
					...
					<div class = "col-lg-6">
						...
						<div class = "qbutton second" onclick = "check(false, 29, 31)">
					...
					<div class = "col-lg-6">
						...
						<div class = "qbutton third" onclick = "check(false, 30, 31)">
					...
					<div class = "col-lg-6">
						...
						<div class = "qbutton fourth" onclick = "check(true, 31, 31)">
						...
						<div class = "bottom">
							...
							<div class = "panel" onclick = "answer(0)">
								...
								<p>
									...
									1. What is the value of 2x + 3 when x = 5?
									...
									b) 8 <br>
									c) 10 <br>
									<span class = "highlight">d) 13</span> <br>
							...
							<div class = "panel" onclick = "answer(1)">
								...
								<p>
									...
									a) 4 <br>
									b) 9 <br>
									<span class = "highlight">c) 11</span> <br>
									d) 14 <br>
							...
							<div class = "panel" onclick = "answer(2)">
								...
								<p>
									...
									3. What is the perimeter of a rectangle with a length of 6 units and a width of 4 units?

									<br><br>

									a) 8 units <br>
									b) 16 units <br>
									<span class = "highlight">c) 20 units</span> <br>
									d) 48 units <br>
							...
							<div class = "panel" onclick = "answer(3)">
								...
								<p>
									...
									4. If you subtract 3 from twice a number and get 11, what is the number?
									...
									b) 5 <br>
									c) 6 <br>
									<span class = "highlight">d) 7</span> <br>
							...
							<div class = "panel" onclick = "answer(4)">
								...
								<p>
									...
									a) 8 <br>
									b) 10 <br>
									<span class = "highlight">c) 12</span> <br>
									d) 24 <br>
							...
							<div class = "panel" onclick = "answer(5)">
								...
								<p>
									...
									6. If 2x + 5 = 11, what is the value of x?
									
									<br><br>

									a) 1 <br>
									b) 2 <br>
									<span class = "highlight">c) 3</span> <br>
									d) 4 <br>
							...
							<div class = "panel" onclick = "answer(6)">
								...
								<p>
									...
									7. Which of the following fractions is equivalent to 3/4?
									
									<br><br>

									<span class = "highlight">a) 6/8</span> <br>
									b) 2/3 <br>
									c) 1/2 <br>
									d) 4/5 <br>
							...
							<div class = "panel" onclick = "answer(7)">
								...
								<p>
									...
									8. If a triangle has sides of lengths 5, 12, and 13, what type of triangle is it?
									...
									b) Isosceles <br>
									c) Scalene <br>
									<span class = "highlight">d) Right</span> <br>
