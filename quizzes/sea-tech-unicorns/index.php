...
<head>
	...
	<title>Southeast Asia's Tech Unicorns: The Origin | Cronicle</title>
	...
	<div class = "container quiz">
		...
		<div class = "row" style = "max-width: 100%;">
			...
			<div class = "col-sm-10 cover page">
				...
				<h1>Southeast Asia's Tech Unicorns: The Origin</h1>

				<p>5 questions • 1 - 2 minutes</p>

				<img src = "image.webp" alt = "tech unicorns" class = "full">
			...
			<div class = "col-sm-10 question page">
				...
				<h3>Which Southeast Asian ride-hailing and on-demand services platform is often considered one of the region's top tech unicorns?</h3>
			...
			<div class = "col-sm-10 question page">
				...
				<h3>What is the Singapore-based online marketplace known for its e-commerce operations across Southeast Asia, and it's often compared to Amazon?</h3>
			...
			<div class = "col-sm-10 question page">
				...
				<h3>Which Southeast Asian tech unicorn is known for its digital payment services and is backed by a prominent Indonesian conglomerate?</h3>
			...
			<div class = "col-sm-10 question page">
				...
				<h3>What is the Malaysian tech startup that focuses on financial technology (FinTech) services?</h3>
			...
			<div class = "col-sm-10 question page">
				...
				<h3>Which Philippines-based tech unicorn is known for its financial services, including digital payments and mobile wallets?</h3>
						...
						<div class = "bottom">
							...
							<div class = "panel" onclick = "answer(0)">
								...
								<p>
									...
									1. Which Southeast Asian ride-hailing and on-demand services platform is often considered one of the region's top tech unicorns?

									<br><br>

									<span class = "highlight">a) Grab</span> <br>
									b) Gojek <br>
									c) Lazada <br>
									d) Shopee <br>
							...
							<div class = "panel" onclick = "answer(1)">
								...
								<p>
									...
									2. What is the Singapore-based online marketplace known for its e-commerce operations across Southeast Asia, and it's often compared to Amazon?

									<br><br>

									a) Gojek <br>
									<span class = "highlight">b) Lazada</span> <br>
									c) Grab <br>
									d) Tokopedia <br>
							...
							<div class = "panel" onclick = "answer(2)">
								...
								<p>
									...
									3. Which Southeast Asian tech unicorn is known for its digital payment services and is backed by a prominent Indonesian conglomerate?

									<br><br>

									a) GoPay <br>
									<span class = "highlight">b) OVO</span> <br>
									c) GrabPay <br>
									d) Dana <br>
							...
							<div class = "panel" onclick = "answer(3)">
								...
								<p>
									...
									4. What is the Malaysian tech startup that focuses on financial technology (FinTech) services?

									<br><br>

									a) AirAsia <br>
									b) Razer <br>
									<span class = "highlight">c) Touch 'n Go</span> <br>
									d) Boost <br>
							...
							<div class = "panel" onclick = "answer(4)">
								...
								<p>
									...
									5. Which Philippines-based tech unicorn is known for its financial services, including digital payments and mobile wallets?
										
									<br><br>

									a) Coins.ph <br>
									<span class = "highlight">b) PayMaya</span> <br>
									c) Lalamove <br>
									d) Traveloka <br>
