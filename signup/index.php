<?php
	...
	if (isset($_POST["register"])) {
		...
		$sqlemail = "SELECT * FROM users `email` = '$email'";

		$result = mysqli_query($db, $sql);
		$resultemail = mysqli_query($db, $sqlemail);

		if (mysqli_num_rows($result) != 1 && mysqli_num_rows($resultemail) != 1) {
...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<span class = "d-flex">
					...
					<p class = "account">Already signed up?</p>
	...
	<div class = "content">
			...
			<?php
				...
				if (isset($_POST["register"])) {
					...
					if (mysqli_num_rows($result) == 1 || mysqli_num_rows($resultemail) == 1) {
						...
						echo "<p class = 'fail'>A user with that username already exists.</p>";
		...
		<p class = "additional">
			...
			Already signed up? <a href = "https://cronicle.space/login/">Log in</a>
