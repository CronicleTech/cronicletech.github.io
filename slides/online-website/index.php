...
<head>
	...
	<title>Getting Your Website Online | Cronicle</title>
	...
	<meta name = "description" content = "Ready to take your website live? Our comprehensive guide walks you through the process of getting your website online. From choosing a domain name and web hosting to setting up your website files and making it accessible to the world, we cover everything you need to know. Follow our step-by-step instructions and tips to confidently launch your website and make it accessible to a global audience.">
		...
		<div class = "row" style = "max-width: 100%;">
			...
			<div class = "col-sm-10 content">
				...
				<div class = "desc">
					...
					<h1>Getting Your Website Online</h1>
					...
					<div class = "row subtitle">
						...
						<p class = "info">4 Minute View</p>

					</div>

					<p class = "caption">

						Servers, websites, and domains are interconnected elements of the online world. Servers are powerful computers that host websites, storing their files and data. Websites are online platforms displaying content, services, or products. Domains are unique web addresses that users type to access websites, acting like online street addresses.

						<br><br>

						Although there are various hosting provider services available, this guide talks about how you can have your website published for free. Using Github Pages is one easy method to get your free domain name and host your website.
