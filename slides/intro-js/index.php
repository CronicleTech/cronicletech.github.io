...
<head>
	...
	<title>Introduction to JavaScript | Cronicle</title>
	...
	<meta name = "description" content = "Discover the fundamentals of JavaScript with our introductory guide. Learn how to add interactivity, functionality, and dynamic behavior to your web projects. Explore the basics of variables, functions, loops, and more. Our guide provides step-by-step tutorials and practical examples to help you start your journey into the world of JavaScript programming.">
			...
			<div class = "col-sm-10 content">
				...
				<div class = "desc">
					...
					<div class = "row subtitle">
						...
						<p class = "info">3 Minute View</p>

					</div>

					<p class = "caption">
						
						JavaScript is a beginner-friendly programming language that adds interactivity to websites. It enables you to create pop-ups, validate forms, and build dynamic elements that respond to user actions. In this guide, you are taught how to draw shapes and fill them with colors.

						<br><br>

						Practice gradually and explore resources like tutorials and coding exercises can enhance your foundational skills in JavaScript. Use the free coding environment at 

						<a href = "https://www.khanacademy.org/computer-programming/new/pjs" target = "blank">
							
							Khan Academy

						</a>

						to practice the functions mentioned in the guide.
